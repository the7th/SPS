                    ...
                    <div class="row">
                        <div class="col-lg-12 col-xs-12 col-sm-12">
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span class="caption-subject bold uppercase font-dark">Students</span>
                                        <span class="caption-helper">List of students</span>
                                    </div>

                                </div>
                                <div class="portlet-body">
                                    <p>Search through students name below</p>
                                </div>
                            </div>
                        </div>
                    </div>
